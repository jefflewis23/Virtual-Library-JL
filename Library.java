...
public class Library {
  //may need an update
   ...
   //methods for adding to the array lists as needed
    ...
    public void printCatalog() {
        ...
        for (int i = 0; i < catalog.size(); i++) {
            System.out.println(catalog.get(i).title + " by " + catalog.get(i).author);
        }
    }
    ...
    public void printAccountInfo() {
        ...
        for (int i = 0; i < accounts.size(); i++) {
            ...
            System.out.println("Name: " + account.accountHolder.name);
